...
export const createHotelValidator = vine.compile(
  vine.object({
    ...
    nightAuditStartTime: vine.number().min(0).max(23).optional(),
    nightAuditEndTime: vine.number().min(0).max(23).optional(),
...
export const updateHotelValidator = vine.compile(
  vine.object({
    ...
    useCashering: vine.boolean().optional(),
    useChannel: vine.boolean().optional(),
  })
)
